...
#SBATCH --job-name=sft_distill1.5b
#SBATCH --output=../log/sft_distill1.5b.out
#SBATCH --error=../log/sft_distill1.5b.error
...
llamafactory-cli train stage1_scripts/sft_distill1.5b.yaml && \
llamafactory-cli export stage1_scripts/merge_distill1.5b.yaml && \
