...
export BASE_MODEL=adamame/model/sft_qwen4b
export DATA_DIR=adamame/2_rl/data
export ALIGN_BONUS=${ALIGN_BONUS:-2.0}
export EXPERIMENT_NAME=adamame_grpo_qwen4b_B${ALIGN_BONUS}
...
# Override B at runtime: ALIGN_BONUS=2.0 bash adamame_grpo_qwen4b.sh

python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=adamame_align \
    algorithm.query_align_bonus=$ALIGN_BONUS \
