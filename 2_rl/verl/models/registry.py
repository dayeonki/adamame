...
try:
    ...
    _qwen3_entry = {'qwen3': _Qwen3Config}
except ImportError:
    _qwen3_entry = {}

try:
    from transformers import SmolLM3Config as _SmolLM3Config
    _smollm3_entry = {'smollm3': _SmolLM3Config}
except ImportError:
    _smollm3_entry = {'smollm3': LlamaConfig}

try:
    from transformers import Cohere2Config as _Cohere2Config
    _cohere2_entry = {'cohere2': _Cohere2Config}
except ImportError:
    _cohere2_entry = {'cohere2': LlamaConfig}

_REOVEPAD_MODELS = {'llama': LlamaConfig, 'mistral': MistralConfig, 'gemma': GemmaConfig, 'qwen2': Qwen2Config,
                    **_qwen3_entry, **_smollm3_entry, **_cohere2_entry}
